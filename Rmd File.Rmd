...
```{r}
set.seed(55)
sampled <- sample(1:vcount(igraphnet), 25)

## pull samples to plot random sampled 
samplegraph <- subgraph(igraphnet, which(V(igraphnet) %in% sampled))

plot(samplegraph,vertex.color = ifelse(V(igraphnet)$Gender == "F", "pink", "blue"))
